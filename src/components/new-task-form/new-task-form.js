...
function NewTaskForm({ onTaskAdded }) {
  ...
  const onTimerChange = (unit, value) => {
        ...
        {label.trim() !== '' && (
          <div className="timer-container">
            ...
            <select
              ...
              onChange={(e) => onTimerChange('months', e.target.value)}
            >
            ...
            <select
              ...
              id="days"
              onKeyDown={handleSubmit}
              onChange={(e) => onTimerChange('days', e.target.value)}
            >
            ...
            <select
              ...
              id="hours"
              onKeyDown={handleSubmit}
              onChange={(e) => onTimerChange('hours', e.target.value)}
            >
