...
export default class TodoApp extends Component {
  ...
  state = {
    ...
    taskData: [
      this.createTask('to сreate static To-Do'),
      this.createTask('to add new tasks'),
      this.createTask('to mark completed'),
      this.createTask('to edit the task text'),
      this.createTask('to remove tasks'),
      this.createTask('to see number of tasks'),
      this.createTask('to filter tasks by status'),
      this.createTask('to clear completed'),
      this.createTask('to break components'),
      this.createTask('to separate'),
      this.createTask('to use props'),
      this.createTask('to use specific task'),
      this.createTask('to respond single'),
      this.createTask('to reverse data flow'),
      this.createTask('to provide data flow'),
      this.createTask('to update state up'),
      this.createTask('to pass Callbacks'),
      this.createTask('to use onChange event'),
      this.createTask('to maintain modularity'),
